...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('competencia.COM_RESULTADOS', function (Blueprint $table) {
            ...
            $table->dateTime('escala', 2)->nullable();
            $table->dateTime('torre', 2)->nullable();
            $table->dateTime('mazo', 2)->nullable();
            $table->dateTime('arrastre', 2)->nullable();
            $table->dateTime('victima', 2)->nullable();
